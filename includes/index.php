 ...
 * @return void
 */
function isg_prune_after_trash( $post_id ) {
	$had = (array) get_post_meta( absint( $post_id ), ISG_GALLERY_META, false );
	if ( ! empty( $had ) ) {
		isg_prune_mirror();
	}
}
add_action( 'trashed_post', 'isg_prune_after_trash' );
 ...
 * question -- see isg_galleries_in_use().
 *
 * @return array
 */
 ...
 * use for ever: the mirror was spared, while isg_posts_for_gallery() -- which
